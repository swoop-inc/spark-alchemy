...
import org.apache.spark.{SparkFunSuite, SparkSuiteBase}
import org.apache.spark.sql._
import org.apache.spark.sql.catalyst.FunctionIdentifier
import org.apache.spark.sql.catalyst.analysis.NoSuchTableException
import org.apache.spark.sql.catalyst.catalog.SessionCatalog.DEFAULT_DATABASE
import org.apache.spark.sql.catalyst.plans.logical.LogicalPlan
import org.apache.spark.sql.catalyst.plans.{PlanTest, PlanTestBase}
...
/**
  ...
  */
trait SQLTestUtils extends SparkSuiteBase with SQLTestUtilsBase with PlanTestBase {
  this: Suite =>
...
trait SQLTestUtilsBase
  ...
  protected lazy val sql = (query: String) => spark.sql(query)
